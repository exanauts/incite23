...
# Load case
const DATA_DIR = joinpath(artifact"ExaData", "ExaData", "matpower")
case_file = joinpath(DATA_DIR, "$(case).m")
load_file = joinpath(@__DIR__, "..", "data", "ACTIVSg_Time_Series", "mp_demand", "case_ACTIVSg10k_Jun_oneweek_1008_10min")
...
algparams.tron_rho_pq=3*1e4
algparams.tron_rho_pa=3*1e5
